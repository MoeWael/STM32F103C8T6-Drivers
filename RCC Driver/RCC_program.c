 ...
 ************************************************************************************************/	
 ...
 void RCC_voidDnableClock(u8 Copy_u8Bus ,u8 Copy_u8PerhID){
	 switch(Copy_u8Bus){
		case RCC_AHB:
				CLEAR_BIT(RCC_AHBENR,Copy_u8PerhID);
					break;
		case RCC_APB1:
				CLEAR_BIT(RCC_APB1ENR,Copy_u8PerhID);
					break;
		case RCC_APB2:
				CLEAR_BIT(RCC_APB2ENR,Copy_u8PerhID);
					break;
	 }
 }
 ...
 {
 	RCC_CFGR |= (ADC_PRESCALER<<RCC_CFGR_ADCPRE1);
 }
